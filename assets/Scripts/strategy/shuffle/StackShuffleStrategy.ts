...
export class StackShuffleStrategy {
  GATHER_DURATION = 0.13;
  PILE_DURATION = 0.2;
  PILE_SPACING = 17.5;
  WAVE_UP_DURATION = 0.1;
  WAVE_DOWN_DURATION = 0.73;
  WAVE_HEIGHT = 30;
  WAVE_BLOCK_DELAY = 0.03;
  EXPAND_DURATION = 0.5;
  BLOCKS_PER_GROUP = 20;
  TILE_WIDTH = 156;
  TILE_HEIGHT = 194;
  GROUP_GAP = 0;
  PERSPECTIVE_OFFSET_RATIO = 0.03;
  totalDuration = 0;
  currentStackGroups = [];
  getName() {
    return "StackShuffle";
  ...
  generateAnimationConfig(e) {
    ...
    var l = this.generateWavePhaseConfigs(n),
      s = l.waveConfigs,
      c = l.waveDuration;
    o.push({
      phase: "wave",
  ...
  createStackGroups(e) {
    ...
    var _ = s.length > 0 ? s[0].cardNode.width : this.TILE_WIDTH,
      T = [],
      C = new Set(),
      b = new Map(),
      E = function E(e) {
  ...
  calculateGroupPosition(e, t, o, n) {
    var i = n + this.GROUP_GAP,
      r = 10 * this.PILE_SPACING + this.GROUP_GAP;
    if (1 === o) return cc.v3(e.x, e.y, e.z);
    if (2 === o) {
      var a = i / 2,
        l = e.x - a,
        s = e.x + a;
  ...
  calculateGroupCount(e) {
    return e < 10 ? 1 : e < 60 ? 2 : e <= 100 ? 3 : 4;
  }
  calculateBlocksPerGroup(e, t) {
    var o = Math.ceil(e / t);
    return Math.min(o, this.BLOCKS_PER_GROUP);
  }
  generateSingleGroupPileConfigs(e, t) {
    for (var o = t.tiles, n = t.position, i = Math.min(o.length, this.BLOCKS_PER_GROUP), r = 0; r < o.length; r++) {
      ...
      if (r >= i) {
        ...
        var s = l ? 0 : r * this.PILE_SPACING,
          c = n.clone().add(cc.v3(0, s, 0));
        e.push({
          node: a.cardNode,
          startOffset: cc.v2(0, 0),
          endPosition: c,
  ...
  generateWavePhaseConfigs(e) {
    var t = this,
      o = [],
      n = [];
    e.forEach(function (e) {
      for (var o = Math.min(e.tiles.length, t.BLOCKS_PER_GROUP), i = 0; i < o; i++) n.push({
        tile: e.tiles[i],
    ...
    for (var i = n.length, r = 0; r < i; r++) {
      var a = n[r],
        ...
        s = a.groupPosition,
        c = a.indexInGroup,
        u = a.groupDisplayCount,
        p = s.clone().add(cc.v3(0, c * this.PILE_SPACING, 0)),
        f = c * this.WAVE_BLOCK_DELAY,
        d = (u - 1 - c) * this.WAVE_BLOCK_DELAY,
        h = Math.max(0.1, this.WAVE_DOWN_DURATION - d);
      o.push({
        node: l.cardNode,
        startOffset: cc.v2(0, 0),
        endPosition: p,
    ...
    var y = 0;
    for (r = 0; r < i; r++) (u = n[r].groupDisplayCount) > y && (y = u);
    var m = (y - 1) * this.WAVE_BLOCK_DELAY,
      v = this.WAVE_DOWN_DURATION;
    return {
      waveConfigs: o,
      waveDuration: m + this.WAVE_UP_DURATION + v
    };
  }
  setupHiddenTilesPosition(e, t, o) {
    var n = null == o ? void 0 : o.hiddenIndices,
      i = null == o ? void 0 : o.tileToGroupPosMap;
    if (n && i) {
  ...
  generateExpandPhaseConfigs(e) {
    var t,
      ...
      n = [],
      i = e.tileNodes,
      r = null === (t = e.extraData) || void 0 === t ? void 0 : t.hiddenIndices;
    i.forEach(function (e, t) {
      var i = (null == r ? void 0 : r.has(t)) || false,
        a = e.tileObject.getPosition();
      n.push({
        node: e.cardNode,
        startOffset: cc.v2(0, 0),
        endPosition: a,
