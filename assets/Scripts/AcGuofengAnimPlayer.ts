...
export class AcGuofengAnimPlayer extends AcAnimPlayerBase {
  completedCount = 0;
      ...
      if (cc.isValid(e)) {
        ...
        cc.tween(e).to(o.PHASE2_DURATION, {
          ...
          progress: function (t, o, n, a) {
            var s = a,
              c = (1 - s) * (1 - s) * i.x + 2 * (1 - s) * s * l.x + s * s * r.x,
              u = (1 - s) * (1 - s) * i.y + 2 * (1 - s) * s * l.y + s * s * r.y;
  ...
  playTrail(e) {
    ...
    if (n) {
      ...
      r.parent = i;
      var l = BaseSprite.create(this.RES_TRAIL_SPRITE, this.RES_BUNDLE);
      l.node.anchorY = 0.8;
      l.node.parent = r;
  ...
  playSpreadCollision() {
    ...
    o.forEach(function (t, o) {
      t.forEach(function (t) {
        var n = o * e.SPREAD_INTERVAL,
          i = t.cardNode1.position.x < t.cardNode2.position.x ? -1 : 1;
  ...
  animateSpreadCard(e, t, o) {
    var n = this;
    return new Promise(function (i) {
      if (cc.isValid(e)) {
        var r,
          a = e.position.clone(),
          l = a.x + t * n.SPREAD_DISTANCE,
        ...
        cc.tween(e).delay(o).to(n.SPREAD_DURATION, {
          ...
          if (r && cc.isValid(r) && cc.isValid(e)) {
            var t = r.convertToWorldSpaceAR(cc.v3(0, 0, 0)),
              o = e.parent;
            r.parent = o;
  ...
  playCollisionEffect(e) {
    var t = this,
      o = (this.nodeInfos[0].targetPos1.y + this.nodeInfos[this.nodeInfos.length - 1].targetPos1.y) / 2;
    [{
      ...
      i.zIndex = n.zIndex;
      BaseSpine.refreshWithNode(i, n.path, t.RES_BUNDLE).setAnimation("in", 1, function () {
        cc.isValid(i) && i.destroy();
      }, false);
    });
  }
  playHitEffect(e, t) {
    ...
    BaseSpine.refreshWithNode(o, this.RES_HIT_SPINE, this.RES_BUNDLE).setAnimation("in", 1, function () {
