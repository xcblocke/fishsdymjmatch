...
import { AcZheshanAnimPlayer } from './AcZheshanAnimPlayer';
export class ACZheShanStrategy {
  getName() {
  ...
  play(e, t) {
    ...
    if (0 !== l.length) {
      var s = new AcZheshanAnimPlayer(t);
      try {
...
AllClearStrategyRegistry.register(6, new ACZheShanStrategy());