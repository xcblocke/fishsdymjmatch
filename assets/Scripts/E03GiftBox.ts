...
import { MapElementId, EJourneyMapState } from './TravelMapInterface';
...
var i;
(i = {})[MapElementId.E03GiftBox1] = ["texture/badge/journey_img_ch_medal_1", "texture/journeyMap/03/journey_bg_medal"];
i[MapElementId.E03GiftBox2] = ["texture/badge/journey_img_ch_medal_2", "texture/journeyMap/03/journey_bg_medal_2"];
i[MapElementId.E03GiftBox3] = ["texture/badge/journey_img_ch_medal_3", "texture/journeyMap/03/journey_bg_medal_3"];
var d = i;
@mj.class
export default class E03GiftBox extends ElementLevel {
  titleLabel = null;
  button = null;
  animNode = null;
  cardNode = null;
  ...
  updateUI() {
    ...
    var t = __read(d[this._data.type], 2),
      o = t[0],
      n = t[1];
    BaseSprite.refreshWithNode(this.badgeIcon, o, false);
    BaseSprite.refreshWithNode(this.badgeBg, n, false);
  }
  resetState() {
  ...
  getBadgeId() {
    var e = 1;
    if (this._data.type === MapElementId.E03GiftBox2) {
      e = 2;
    } else {
      this._data.type === MapElementId.E03GiftBox3 && (e = 3);
    }
    return e;
  }
  playAnim(e, t) {
