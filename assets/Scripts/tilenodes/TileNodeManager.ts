...
export default class TileNodeManager {
  _tileNodeMap = new Map();
  _scheduleComponent = null;
  _currentZIndexBase = 0;
  _sameLayerMap = new Map();
  _layerIndex2NodeMap = {};
  _layerIndex2ShadowNodeMap = {};
  _context = null;
  _cardLayoutConfig = null;
  _cardConfigMap = null;
  _tileMapObject = null;
  get root() {
  ...
  getTileNodes() {
    var e,
      t = Array.from(this._tileNodeMap.values());
    if ((null === (e = this.context) || void 0 === e ? void 0 : e.gameType) != MjGameType.Classic) return t;
    t.sort(function (e, t) {
      var o,
        n,
        i,
        ...
        f,
        d,
        h = null !== (n = null === (o = e.tileObject) || void 0 === o ? void 0 : o.gridPosX) && void 0 !== n ? n : 0,
        y = null !== (r = null === (i = e.tileObject) || void 0 === i ? void 0 : i.gridPosY) && void 0 !== r ? r : 0,
        m = null !== (l = null === (a = e.tileObject) || void 0 === a ? void 0 : a.layer) && void 0 !== l ? l : 0,
        v = null !== (c = null === (s = t.tileObject) || void 0 === s ? void 0 : s.gridPosX) && void 0 !== c ? c : 0,
        g = null !== (p = null === (u = t.tileObject) || void 0 === u ? void 0 : u.gridPosY) && void 0 !== p ? p : 0,
        _ = null !== (d = null === (f = t.tileObject) || void 0 === f ? void 0 : f.layer) && void 0 !== d ? d : 0;
      if (m !== _) return m - _;
      var T = h + 2 * y,
        C = v + 2 * g;
      return T === C ? h - v : T - C;
  ...
  rebuildTileNodeInfosAfterShuffle(e) {
    var t,
      o,
      n,
      i,
    ...
    try {
      for (var u = __values(e), p = u.next(); !p.done; p = u.next()) {
        var f = p.value,
          d = null === (a = f.info) || void 0 === a ? void 0 : a.tileObject;
        if (d && d.isValid) {
          if (d.getTypeBits() !== f.typeBits) {
            var h = f.cardNode.position.clone(),
              y = f.shadowCardNode.position.clone();
            f.onlyClear();
          ...
          var m = f.info.layerIndex,
            v = d.layer;
          null === (l = this._sameLayerMap.get(m)) || void 0 === l || l.delete(d.id);
          this._sameLayerMap.has(v) || this._sameLayerMap.set(v, new Map());
          var g = this._layerIndex2NodeMap[v],
            _ = this._layerIndex2ShadowNodeMap[v],
            T = null === (s = this._tileMapObject) || void 0 === s ? void 0 : s.mapLayers()[v],
            C = T ? T.allCards.indexOf(d) : -1;
          f.info.layerIndex = v;
          f.info.layerNode = g;
  ...
  rebuildChangeTypeTileNodes(e) {
    ...
    try {
      for (var p = __values(l), f = p.next(); !f.done; f = p.next()) {
        var d = f.value,
          h = this._tileNodeMap.get(d);
        if (h) if (h.initType != h.info.tileObject.showType) {
          var y = h.info;
      ...
      return __generator(this, function (i) {
        switch (i.label) {
          case 0:
            ...
            if (this._context.gameType != MjGameType.Classic) return [3, 5];
            o = 0;
            i.label = 1;
          case 1:
            if (!(o < this._tileMapObject.mapLayers().length)) return [3, 4];
            if (!(n = this._tileMapObject.mapLayers()[o]).hasValidCard()) return [3, 3];
          ...
          case 5:
            ...
            i.label = 6;
          case 6:
            if (!(o <= this._tileMapObject.maxLayerIndex)) return [3, 9];
      ...
      return __generator(this, function (i) {
        switch (i.label) {
          ...
          case 1:
            if (!(y < t)) return [3, 4];
            m = e.addLayers[y];
            if (!(f = this._tileMapObject.mapLayers()[m]) || !f.hasValidCard()) return [3, 3];
  ...
  destoryEmptyLayerNodes() {
    var e, t, o;
    if (cc.isValid(this.root)) {
      var n = this.root.children,
        i = function i(e) {
          if (cc.isValid(e) && 0 == (null === (o = e.children) || void 0 === o ? void 0 : o.length)) {
            ...
            if (!t) {
              for (var n in a._layerIndex2NodeMap) if (a._layerIndex2NodeMap[n] === e) {
                delete a._layerIndex2NodeMap[n];
                break;
              }
              for (var n in a._layerIndex2ShadowNodeMap) if (a._layerIndex2ShadowNodeMap[n] === e) {
        ...
        a = this;
      try {
        for (var l = __values(n), s = l.next(); !s.done; s = l.next()) i(s.value);
      } catch (t) {
        e = {
          error: t
        };
  ...
  createLayer(e, t = 0) {
    var o = this._currentZIndexBase + 2 * e,
      n = new cc.Node();
  ...
  createTileNodeObject(e, t, o) {
    var n = this._layerIndex2ShadowNodeMap[o],
      i = this._layerIndex2NodeMap[o];
    if (!n || !i) return null;
    var r = TileNodeFactory.getInstance().getTileNodeObject(e, this.context.gameType);
    r.refreshNode({
  ...
  handleFallingTileNode(e, t, o) {
    var n, i;
    this._sameLayerMap.has(t) || this._sameLayerMap.set(t, new Map());
    var l = this._sameLayerMap.get(t),
      s = this._tileNodeMap.get(e.id);
    if (!s) return false;
  ...
  updateTileNodeLayer(e, t, o) {
    var n = this._layerIndex2NodeMap[t],
      i = this._layerIndex2ShadowNodeMap[t];
    if (n && i) {
      var r = e.cardNode;
  ...
  updateLayerSiblingIndexes(e) {
    var t,
      o,
      n,
      i,
      a = this._sameLayerMap.get(e);
    if (a && 0 !== a.size) try {
  ...
  updateLayerShadowSize(e) {
    var t,
      o,
      n = this._sameLayerMap.get(e);
    if (n && 0 !== n.size) try {
      for (var i = __values(n.values()), a = i.next(); !a.done; a = i.next()) a.value.resetShadowSize();
    } catch (e) {
      t = {
        error: e
      };
