export class NodeAnimator {
  ...
  static defaultAnimationType = "default";
  ...
  static setDefaultAnimationType(e) {
    this.executors.has(e) && (this.defaultAnimationType = e);
  }
  static getDefaultAnimationType() {
    return this.defaultAnimationType;
  }
  static execute(e) {
    this.initialized || this.init();
    this.animatingNodes.add(e.node);
    if (e.customExecutor) return e.customExecutor(e.node, e);
    var t = e.animationType || this.defaultAnimationType,
      o = this.executors.get(t);
  ...
  static spiralToCenterExecutor(e, t) {
    var o = t.delay,
      n = t.duration,
      i = t.easing,
      r = t.extraParams;
    if (r && r.centerPos) {
      var a = r.centerPos,
        ...
        c = r.fadeOut || false,
        u = e.position.clone(),
        p = u.clone().subtract(a).mag(),
        f = u.clone().subtract(a),
        d = Math.atan2(f.y, f.x),
        h = 2 * l * Math.PI * (s ? -1 : 1),
        y = e.opacity,
        m = i ? cc.easing[i] : null;
      return cc.tween({
        value: 0
      }).delay(o).to(n, {
        value: 1
  ...
  static spiralFromCenterExecutor(e, t) {
    var o = t.endPosition,
      n = t.delay,
      i = t.duration,
      r = t.easing,
  ...
  static stackMoveExecutor(e, t) {
    var o = t.endPosition,
      n = t.delay,
      i = t.duration,
      r = t.easing,
      a = t.extraParams,
      l = cc.tween(e).delay(n);
  ...
  static stackPileExecutor(e, t) {
    var o = t.endPosition,
      n = t.delay,
      i = t.duration,
      r = t.easing,
      a = t.extraParams;
    if (null == a ? void 0 : a.isBottom) return cc.tween(e).delay(n).start();
  ...
  static stackWaveExecutor(e, t) {
    ...
    var r = i.waveHeight,
      a = i.upDuration,
      l = i.downDuration,
      s = i.upEasing || "circOut",
      c = i.downEasing || "sineInOut",
      u = e.position.clone(),
      p = o || u,
      f = u.clone().add(cc.v3(0, r, 0));
  ...
  static stackExpandExecutor(e, t) {
    var o = t.endPosition,
      n = t.delay,
      i = t.duration,
      r = t.easing,
  ...
  static topMaskMoveExecutor(e, t) {
    var o = t.startOffset,
      n = t.endPosition,
      i = t.delay,
      r = t.duration,
    ...
    e.setPosition(c);
    e.opacity = 0;
    var u = (null == l ? void 0 : l.maskTopY) || s.y + o.y,
      p = o.y,
      f = u - 40,
      d = (Math.max(0, (c.y - f) / p), a ? cc.easing[a] : cc.easing.quadOut);
    return cc.tween({
      value: 0
    }).delay(i).to(r, {
      value: 1
      ...
      progress: function (t, o, n, i) {
        ...
        if (l > f) e.opacity = 0;else {
          var u = f - s.y,
            p = (f - l) / u,
            h = Math.min(1, Math.max(0, p)),
            y = Math.min(1, h / 0.3);
