...
export class AcZheshanAnimPlayer extends AcAnimPlayerBase {
  completedCount = 0;
  ...
  playCollision() {
    var e = this,
      t = this.nodeInfos[0].cardNode1.getContentSize().height,
      o = this.nodeInfos[0].cardNode1.getContentSize().width,
      n = 0.5 * t,
