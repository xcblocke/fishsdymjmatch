...
export class DaxiaoAnimPlayer {
  ...
  setupPositions(e, t) {
    var o = this;
    e.sort(function (e, t) {
      var n = o.context.getTileObject(e.tileId2),
        i = o.context.getTileObject(t.tileId2);
    ...
    var n,
      ...
      r = (e[0].cardNode1.getContentSize().width, i + t),
      a = -(e.length * r + (e.length - 1) * t) / 2 + r / 2,
      l = false !== this.config.phase1.randomOrder;
      ...
      if (cc.isValid(e)) {
        ...
        cc.tween(e).to(o, {
          ...
          progress: function (t, o, n, a) {
            var l = a < 0.5 ? 2 * a * a : 1 - Math.pow(-2 * a + 2, 2) / 2,
              s = (1 - l) * (1 - l) * i.x + 2 * (1 - l) * l * d + l * l * r.x,
              c = (1 - l) * (1 - l) * i.y + 2 * (1 - l) * l * h + l * l * r.y;
  ...
  playPhase1(e, t, o = false) {
    for (var n = Array.isArray(t.duration) ? t.duration : [t.duration], i = Array.isArray(t.moveY) ? t.moveY : [t.moveY], r = Math.max(n.length, i.length); n.length < r;) n.push(n[n.length - 1] || 0);
    for (; i.length < r;) i.push(i[i.length - 1] || 0);
    return this.playPhase1Stages(e, n, i, t, o);
  }
  playPhase1Stages(e, t, o, n, i) {
    var r = this;
    ...
    for (var a = Promise.resolve(), l = e.position.y, s = function s(s) {
        ...
        l = u;
      }, c = 0; c < t.length; c++) s(c);
    return a;
  }
  playPhase2(e, t, o, n = false) {
    var i, r;
    var a = void 0 !== o.angle || void 0 !== o.scale,
      l = null !== (i = o.transformDuration) && void 0 !== i ? i : o.restoreDelay;
    if (a) {
    ...
    } else cc.tween(e).to(o.restoreDelay, {
      angle: 0,
      scale: 1
    }).start();
  ...
  playTrailEffect(e, t, o, n, a, l, s) {
    var c = this,
      u = new cc.Node("TrailContainer");
    u.parent = e;
    u.position = cc.v3(o.x, o.y, 0);
    u.zIndex = 400;
    u.scale = t || 1;
    if (l.trailSpine) {
      BaseSpine.create(l.trailSpine.path, l.trailSpine.anim || "in", -1, null, false, l.trailSpine.bundle).node.parent = u;
    } else {
      l.trailSprite && (BaseSprite.create(l.trailSprite.path, l.trailSprite.bundle).node.parent = u);
    }
  ...
  showFlowLight(e, t, o, n) {
    ...
    if (!e.getChildByName("DaxiaoFlowLightNode")) {
      ...
      e.addChild(a);
      a.scale = t;
      BaseSpine.refreshWithNode(a, o, n).setAnimation("init", -1, null, false);
    }
  }
  playHitEffect(e, t, o, n, r = true) {
    var a = BaseSpine.create(o, "in", 1, null, false, n);
  ...
  playEliminationEffect(e, t, o) {
    var r, a;
    if (o) try {
      for (var l = __values(t), s = l.next(); !s.done; s = l.next()) {
        var c = s.value,
          u = BaseSpine.create(o.path, "in", 1, null, true, o.bundle);
        u.node.parent = e;
  ...
  playCollisionCompleteEffect(e, t, o) {
    if (o.backSpine) {
      var n = BaseSpine.create(o.backSpine.path, "in", 1, null, true, o.backSpine.bundle);
      n.node.parent = e;
      n.node.position = cc.v3(-t / 2, 0, 0);
      n.node.zIndex = 500;
      var r = BaseSpine.create(o.backSpine.path, "in", 1, null, true, o.backSpine.bundle);
      r.node.parent = e;
    ...
    if (o.effectSpine) {
      var a = BaseSpine.create(o.effectSpine.path, "in", 1, null, true, o.effectSpine.bundle);
      a.node.parent = e;
      a.node.zIndex = 500;
    }
  }
  calculateYPositions(e, t, o) {
    if (o <= 0) return [];
    if (1 === o) return [(e + t) / 2];
    var n = (e - t) / (o - 1);
    return Array.from({
  ...
  runCard1Animation(e) {
    var t = this,
      o = this.config,
      n = this.nodeInfos.length,
      i = e.runIndex * o.phase1.delay,
      r = (n - 1 - e.runIndex) * o.phase1.delay,
      a = 0.067 * e.runIndex;
    this.delay(e.cardNode1, i).then(function () {
      ...
      var n = t.playPhase2(e.cardNode1, e.targetPos1, o.phase2),
        i = o.phase2.trailDelay || 0;
  ...
  triggerTrail(e) {
    var t = this,
      o = this.context.effectNode,
      n = e.cardNode1.position.clone(),
      i = this.context.getTileNodePos(e.tileId2);
    if (i) {
  ...
  runCard2Animation(e) {
    ...
    var i = this.context.layoutScale || 1,
      r = false !== o.trail.hitFollowTarget;
  ...
  onCollisionComplete() {
    var e = this.context.effectNode,
      t = this.config.resources,
      o = Math.min(this.nodeInfos.length, 3);
    if (o > 0) {
      var n = this.nodeInfos[0].targetPos1.y,
        i = this.nodeInfos[this.nodeInfos.length - 1].targetPos1.y;
  ...
  showClearTip(e) {
    ...
    BaseSpine.refreshWithNode(o, n.path, n.bundle).setAnimation("init", -1, null, false);
  }
}