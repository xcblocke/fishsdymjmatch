...
var i;
(i = {})[MapElementId.E01GiftBox1] = "texture/badge/journey_img_medal_1";
i[MapElementId.E01GiftBox2] = "texture/badge/journey_img_medal_2";
i[MapElementId.E01GiftBox3] = "texture/badge/journey_img_medal_3";
var f = i;
@mj.class
export default class E01GiftBox extends ElementLevel {
  titleLabel = null;
  button = null;
  animNode = null;
  cardNode = null;
  ...
  selectAnim = null;
  badgeUpBg = null;
  static prefabUrl = "prefabs/journeyMap/01/E01GiftBox";
  ...
  updateUI() {
    ...
    BaseSprite.refreshWithNode(this.badgeIcon, f[this._data.type], false);
  }
  resetState() {
  ...
  getBadgeId() {
    var e = 1;
    if (this._data.type === MapElementId.E01GiftBox2) {
      e = 2;
    } else {
      this._data.type === MapElementId.E01GiftBox3 && (e = 3);
    }
    return e;
  }
  playAnim(e, t) {
