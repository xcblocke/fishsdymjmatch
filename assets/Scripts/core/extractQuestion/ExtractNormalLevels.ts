...
export class ExtractDimension {
  static DECAY_COEFFICIENT = 2;
  static InitDu = 400;
  static _alterIndexs = [];
  static alterIntervalItems = [];
  static isFix = false;
  static timeOutMax = 1000;
  static saveData(e) {
  ...
  static getEt(e) {
    ...
    if (!o) return 0;
    if (!t.subArr || 0 == t.subArr.length) return 0;
    this.checkFixedRUAndDU();
    var n = (t = this.getData()).chooseIndex,
      i = t.subArr;
    ...
    var r = this.getM(),
      a = 400 == t.subArr[n].du ? t.ru : t.subArr[n].ru;
  ...
  static getAllDirectReadWeights() {
  ...
  static getDimensionOrder() {
    return [1, 2, 3, 2];
  }
  @mj.traitEvent("ExtNormLv_getLvPriority")
  static getLevelPriorityOrder() {
    return [1, 2, 3, 4];
  }
  @mj.traitEvent("ExtNormLv_getDeathFail")
  static getDeathFailAdjust(e = 0) {
    return -2;
  }
  @mj.traitEvent("ExtNormLv_getDeathPass")
  static getDeathPassAdjust(e = 0) {
    return 1;
  }
  @mj.traitEvent("ExtNormLv_hasDeathDirAdj")
  static hasDeathDirectAdjust() {
    return false;
  }
  @mj.traitEvent("ExtNormLv_getDeathDirAdj")
  static getDeathDirectAdjust() {
    return 0;
  }
  static UpdateCapability(t, o, n) {
    var i = this.getData(),
      r = this.getOriginConfigData();
    if (r && i.subArr && 0 != i.subArr.length) {
      this.checkFixedRUAndDU();
      if (this.isFix) this.isFix = false;else {
        var a = (i = this.getData()).chooseIndex,
          l = i.subArr;
        ...
        if (i.subArr[a]) {
          var s = this.getK(r),
            c = this.getM(),
            u = 400 == i.subArr[a].du ? i.ru : i.subArr[a].ru;
          u = Math.max(u, r.MinDiffulty);
          var p = Math.max(t, r.MinDiffulty),
            f = 1 / c * p * (p / u);
          ...
          var d = f / o,
            ...
            y = Math.abs(1.25 - d),
            m = this.getLogBase(),
            v = Math.log(n + 1) / Math.log(m),
            g = ExtractDimension.getLogValueLimit(),
            _ = Math.min(v, g),
            T = s * h * (l[a].du / 350) * _ / g,
            C = l[a].ru,
            b = 0.8 * C,
            E = r.MaxDiffulty - 0.2 * (r.MaxDiffulty - r.MinDiffulty);
          ...
          } else l[a].du = Math.max(0.6 * l[a].du, 30);
          i.diffcult = p;
  ...
  static afterCapabilityUpdate() {}
  static updateTriggerSupportMechanismState(e, t, o) {
    1 === e.tiggerPatch3 && t <= 1.5 * o && (e.tiggerPatch3 = 2);
  }
  static updateOverall(e) {
    for (var t = this.getOriginConfigData(), o = [], n = 0; n < e.subArr.length; n++) e.subArr[n].du != this.InitDu && o.push([e.subArr[n].ru, e.subArr[n].du]);
    if (o.length > 0) {
      var i = 0,
        r = 0;
    ...
    var a = [];
    for (n = 0; n < e.subArr.length; n++) e.subArr[n].du != this.InitDu && a.push(e.subArr[n].du);
    if (a.length > 0) {
      var l = 0;
  ...
  static getLevelName(e, t) {
    var o, n;
    if (!e) {
      console.error("【关卡抽取】没有传游戏表数据");
      return t;
    }
    var r = this.getData().historyIndex || [],
      a = ExtractNormalLevels.getInstance();
    ...
    var l = this.getLevelPriorityOrder(),
      s = function s(e, t) {
        for (var o = e.split("_"), n = t.split("_"), i = 0, r = Math.min(o.length, n.length), a = 0; a < r; a++) {
          var s = (a < l.length ? l[a] : a) - 1;
          if (!(s >= r)) if (o[s] == n[s]) i += Number(Math.pow(10, o.length - a));else if (Number(o[a]) && Number(n[a])) {
  ...
  static getTileCountDimension() {
    return "03";
  }
  static getMaJiangWeiDu(e, t, o, n) {
  ...
  static getGuideNum() {
    var e,
      t = TraitManager.getInstance().getTraitData("FixedLevels");
    return (null === (e = null == t ? void 0 : t.fixLevelArr) || void 0 === e ? void 0 : e.length) || 0;
  }
  @mj.traitEvent("ExtNormLv_getMaxNDieLevel")
  static getMaxNotDieLevel() {
    return 4;
  }
  @mj.traitEvent("ExtNormLv_getDeathLv")
  static getDeathLvMension(e, t, o, n = 0, i?) {
    o || (o = this.getMaxNotDieLevel());
    "number" != typeof e && (e = 1);
    var r = this.getData(),
      a = r.dieDimensionValue || 1;
    if (t <= o) a = 1;else if (this.hasDeathDirectAdjust(i)) {
  ...
  static GetDimension(e = 0) {
    var t = this.getAllDirectReadWeights(),
    ...
    for (var i = Math.floor(Math.random() * (n + 1)), r = 0, a = 1, l = 0; l < o.length; ++l) if (i <= (r += o[l])) {
      a = l + 1;
      break;
    }
    return "0" + a;
  }
  static checkFixedRUAndDU() {
    var e,
      t = null === (e = mj.getClassByName("ExtractTool")) || void 0 === e ? void 0 : e.getCurrentGameType();
    if (t === MjGameType.Normal || t === MjGameType.Tile2Normal) {
      var o = this.getData(),
        n = this.getOriginConfigData();
      if (o && o.subArr && n) {
        if (o.subArr) {
          ...
          for (var r = function r(e) {
              var t = n.CapabilityDimensionName[e],
                r = o.subArr.find(function (e) {
              ...
              r.index = e;
              i.push(r);
            }, l = this, s = 0; s < n.CapabilityDimensionName.length; s++) r(s);
          this.isFix && i.length > 0 && (o.subArr = i);
        }
        if (this.isFix) {
          o.currentAllCapabilityDimensionName || (o.currentAllCapabilityDimensionName = []);
          o.currentAllCapabilityDimensionName = [...n.CapabilityDimensionName];
  ...
  static printSubArrStatus(e, t) {
    for (var o = 0; o < t.length; o++) (null == (n = t[o]).ru || isNaN(n.ru)) && (n.ru = n.subSmin);
    var n;
  }
  ...
  static getInitialCapabilityRU(e, t) {
    return t.MinDiffulty;
  }
  static getNengLiWeiDu(e) {
    var t = this.getData(),
      o = this.getConfigData();
    if (!o) {
    ...
    var n = this.getOriginConfigData(),
      i = !t.ru,
      r = t.ru,
      l = t.du;
    ...
    for (var f = Math.log(e) / Math.log(1.3), d = r * Math.min(f, 10) / 100, h = new Date().getTime(), y = o.MinDiffulty, m = o.MaxDiffulty, v = 0, g = 0, _ = 0;;) {
      ...
      var T = this.getAlterItem(e),
        C = null != T && T.sortCapabilityDimensionNameList && T.sortCapabilityDimensionNameList.length > 0,
        b = [];
      if (C) {
      ...
      if (this.isOpenPatch2() && l < 250) {
        var I = this.getPatch0201(),
          w = this.getPatch0202(),
          B = Math.min.apply(Math, [...t.subArr.map(function (e) {
            return e.subSmin;
          })]),
          x = Math.floor(Math.min(t.subArr.length / 3 + 1, w));
        for (u = 0; u < t.subArr.length; ++u) if ((O = t.subArr[u]).isOpen) {
    ...
    var j = 400 == t.subArr[v].du ? r : t.subArr[v].ru,
      k = n.CapabilityDimensionName;
    t && null == t.currentAllCapabilityDimensionName && (t.currentAllCapabilityDimensionName = [...n.CapabilityDimensionName]);
    t.chooseIndex = v;
    t.diffcult = g;
    t.ru = r;
    t.du = l;
  ...
  static SelectCapabilityRange(e, t, o) {
    ...
    if (t.length > 0 && e[o].du == this.InitDu) {
      ...
      for (var r = 0; r < n.length; r++) if (e[o].index === n[r].index) {
        i = r;
        break;
      }
      var a = null,
        l = 0;
      for (r = 0; r < n.length; r++) if (n[r].du < this.InitDu) if (null == a) a = n[r];else if (n[r].subSmin > a.subSmin) {
        a = n[r];
        l = r;
      }
      var s,
      ...
      var u = Math.floor(Math.min(s, i)),
        p = Math.floor(Math.max(s, i));
      for (r = u; r <= p; r++) {
        var f = n[r];
        if (f.bValue < 1) {
          o = f.index;
  ...
  static AddDullVal(e, t) {
    e[t].bValue += this.getPatch0401();
  }
  static GetCanSelectIndexList(e, t) {
  ...
  static IsSatisfy(e, t) {
    var o = true;
    e[t].bValue >= 1 && (o = false);
    return o;
  }
  static AllDullValReduce(e, t) {
  ...
  static calcDifficultyValue(e, t, o) {
    var n = 1 - Math.random(),
      i = 1 - Math.random();
    return e * o + t * (Math.sqrt(-2 * Math.log(n)) * Math.sin(2 * Math.PI * i));
  }
  static getD(e, t, o, n, i, r) {
    var a = this.getAdjustedRU(0.9),
      l = this.getM(),
      s = this.calcDifficultyValue(e, t, a, l, r);
    s = this.clamp(s, o, n);
    if (this.isOpenPatch3()) {
      ...
      if (e <= n - c * (n - o) || 0 == i.tiggerPatch3 || 2 == i.tiggerPatch3) {
        ...
        s = Math.max(s, u);
      } else i.tiggerPatch3 = 0;
    }
    return s;
  }
  static BeforeAlterDimensionNameList(e, t, o) {
    this._alterIndexs = [];
  ...
  static FixDUseAlterDimensionNameList(e, t, o, n) {
    this.alterIntervalItems = [];
    if (null != t) {
      for (var i = 0, r = function r(e) {
          var r = o.sortCapabilityDimensionNameList[e],
            a = t.find(function (e) {
              return Number(e.dimensionName) === Number(r);
            });
          if (null != a) {
            if (!n.CapabilityDimensionName.includes(a.dimensionName)) return "continue";
            if (a.isOpen && i < o.alterMaxCount) {
              i++;
              l.alterIntervalItems.push(a);
            } else a.isOpen;
          }
        }, l = this, s = 0; s < o.sortCapabilityDimensionNameList.length; s++) r(s);
      if (this.alterIntervalItems.length > 0) {
        var c = Math.min.apply(Math, [...this.alterIntervalItems.map(function (e) {
            return e.subSmin;
          })]),
          u = Math.max.apply(Math, [...this.alterIntervalItems.map(function (e) {
            return e.subSmax;
          })]);
        e = this.clamp(e, c, u);
      }
  ...
  static AlterChooseIndexFix(e, t) {
    return this._alterIndexs.includes(t) ? t : e;
  }
  static calculateStackedFactor(t, o = ExtractDimension.DECAY_COEFFICIENT) {
...
export default class ExtractNormalLevels {
  ...
  getCacheKey() {
    ...
    if (e) {
      var t = e.getCurrentGameType(),
        o = e.getCurrentJourneyType();
  ...
  setOriginConfigData(e, t) {
    this.originConfigData_cache.set(e, t);
  }
  loadLevelOffsetByteData(e, t, o) {
    var n = this,
      a = o || this.getCacheKey();
    return new Promise(function (o, s) {
      new Date().getTime();
      var c = n.getlevelDataOffset();
      if (c) o(c);else {
        var u = __read(n.getOffsetPath(e, t), 2),
          p = u[0],
          f = u[1],
          d = function d(e) {
            for (var t, r, l = [], s = new Uint8Array(e), c = 0; c < e.byteLength; c++) l.push(s[c]);
        ...
        resManager.loadRes(p, cc.BufferAsset, f).then(function (e) {
          if (e) {
            if (e instanceof cc.BufferAsset) {
              var t = e._buffer;
              d(t);
              e.decRef();
            } else s(new Error("Loaded resource is not BufferAsset"));
          } else s(new Error("Failed to load BufferAsset"));
        }).catch(function (e) {
          s(e);
        });
      }
  ...
  loadLevelByteData(e, t, o) {
    var n = this,
      i = o || this.getCacheKey();
    return new Promise(function (o, a) {
      var s = __read(n.getLevelDataPath(e, t), 2),
        c = s[0],
        u = s[1];
      new Date().getTime();
      resManager.loadRes(c, cc.BufferAsset, u).then(function (e) {
        if (e) {
          if (e instanceof cc.BufferAsset) {
            var t = e._buffer;
            ...
            o(null);
            e.decRef();
          } else a(new Error("Loaded resource is not BufferAsset"));
        } else a(new Error("Failed to load BufferAsset"));
      }).catch(function (e) {
        a(e);
      });
    });
  }
  loadConfigData(e, t, o) {
    var n = this,
      i = o || this.getCacheKey();
    return new Promise(function (o, a) {
      new Date().getTime();
      ...
      if (s) {
        ...
        var u = __read(n.getConfigPath(e, t), 2),
          p = u[0],
          f = u[1];
        resManager.loadRes(p, cc.JsonAsset, f).then(function (e) {
          if (e) {
  ...
  getAllIndexesInTable(e) {
    if (!this.getAllNamesData().includes(e)) return [];
    var t = this.getLevelData(),
      o = this.getlevelDataOffset()[e];
    if (!o) return [];
    var n = o.startOffset,
      i = (o.fileLeng, new DataView(t)),
      r = i.byteLength;
    if (n + 4 > r) {
  ...
  getByteContentByType(e, t) {
    var o = this.getAllNamesData(),
      n = ExtractDimension.getData(),
      i = n.historyIndex || [];
    if (o.includes(e)) {
      var r = this.getLevelData(),
        a = this.getlevelDataOffset()[e],
        l = a.startOffset,
        s = a.fileLeng + l,
        c = new DataView(r),
        u = c.byteLength,
  ...
  decodeUTF8(e) {
    for (var t = "", o = 0; o < e.length;) {
      ...
      if (0 == (128 & n)) {
        ...
        if (!(o + 3 < e.length)) break;
        if ((i = (7 & n) << 18 | (63 & e[o + 1]) << 12 | (63 & e[o + 2]) << 6 | 63 & e[o + 3]) > 65535) {
          var r = Math.floor((i - 65536) / 1024) + 55296,
  ...
  get16BitValue(e) {
    ...
    var s = bigNum(e).shiftRight(24).and(bigNum(65535)),
      c = bigNum.zero,
      u = s;
    for (l = 0; l < 16; l++) {
  ...
  getRandomContent() {
    ...
    if (!e || 0 === e.length) return Promise.resolve(null);
    var t = e[Math.floor(Math.random() * e.length)],
      o = this.getAllIndexesInTable(t);
    if (!o || 0 === o.length) return Promise.resolve(null);
    var n = o[Math.floor(Math.random() * o.length)];
    return this.getContentByTableAndIndex(t, n);
  }
  getByteDataByIndex(e, t) {
    var o = this.getLevelData(),
      n = this.getlevelDataOffset();
    if (!o || !n) return null;
    var i = n[e];
    if (!i) return null;
    var r = i.startOffset,
    ...
    for (var p = Math.min(r + u, l); r + c <= p;) {
      ...
      r += 4;
      if (f === t) {
        var g = o.slice(p, i.startOffset + i.fileLeng).slice(m, m + v),
          _ = new Uint8Array(g);
        return {
  ...
  getContentByTableAndIndex(e, t) {
    var o = this.getByteDataByIndex(e, t);
    if (!o) return Promise.resolve(null);
    var n = o.contentByteStr,
      i = o.difficulty,
      r = o.index,
      a = this.get16BitValue(n.split(",")[0].trim()),
      l = e.split("_")[0] + "_" + e.split("_")[1],
      s = e.split("_")[0] || "random";
    return this.loadBoardAndBuildContent(l, a, n).then(function (t) {
      return t ? [t, i, r.toString(), e, s] : null;
    });
  }
  loadBoardAndBuildContent(e, t, o) {
    var n = this,
      i = this.getBoardConfig();
    if (i.has(e)) {
      var a = i.get(e),
        s = this.buildContentFromBoard(a, t, o);
      return Promise.resolve(s || null);
    }
    var c = __read(this.getJsonPath(e), 2),
      u = c[0],
      p = c[1];
    return resManager.loadRes(u + e, cc.JsonAsset, p).then(function (r) {
      if (!r) return null;
      i.set(e, r.json);
  ...
  buildContentFromBoard(e, t, o) {
    if (!e) return "";
    for (var n = 0; n < e.length; n++) if (Number(e[n].Index) == Number(t)) return (e[n].Content + "|" + o).toString();
    return "";
  }
  ...
  getContent(e) {
    var t = this,
      o = new Date().getTime(),
      n = this.getByteContent(e);
    if (!n) return Promise.resolve([this.getDouDiData(), 55, "兜底索引", "兜底表名", "07"]);
    var i = n.fileName.split("_")[0] + "_" + n.fileName.split("_")[1],
      a = n.contentByteData,
      s = this.get16BitValue(a.split(",")[0].trim()),
      u = null,
      p = this.getBoardConfig();
    if (p.has(i)) {
      u = p.get(i);
      return Promise.resolve(this.processContentData(u, s, a, n, o));
    }
    var f = __read(this.getJsonPath(i, e.gameType, e.journeyType), 2),
      d = f[0],
      h = f[1];
    return resManager.loadRes(d + i, cc.JsonAsset, h).then(function (e) {
      if (!e) {
        var r = t.getDouDiData();
        DDebugInfo.dot("抽题异常 Board配置加载失败: " + i + " index: " + s);
  ...
  processContentData(e, t, o, n) {
    var i = "";
    if (e) for (var r = 0; r < e.length; r++) if (Number(e[r].Index) == Number(t)) {
      i = (e[r].Content + "|" + o).toString();
      break;
    }
    if (!i) {
      i = this.getDouDiData();
      DDebugInfo.dot("抽题异常 题库异常,fileName: " + n.fileName + " 造型index: " + t + " 哈希index :" + n.index + " - 未找到对应内容，使用兜底数据");
    }
    new Date().getTime();
    return [i, n.contentDiff, n.index, n.fileName, n.fileName.split("_")[0]];
  }
  updateCapability(e, t, o) {
