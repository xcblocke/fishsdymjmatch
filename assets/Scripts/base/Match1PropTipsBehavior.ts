...
export class Match1PropTipsBehavior extends GameBehaviorsBase {
  _timeout = 0;
  ...
  handleStart(e, t) {
    ...
    if (a) {
      var l = this.context.gameView,
        s = null == l ? void 0 : l.bottomRootNode,
        c = null == s ? void 0 : s.getChildByName("btnShuffle");
      if (c && cc.isValid(c)) {
  ...
  handleStop() {
    ...
    var o = this.context.gameView,
      n = null == o ? void 0 : o.bottomRootNode,
      i = null == n ? void 0 : n.getChildByName("btnShuffle"),
      r = i ? i.__match1PropTipsTimerCb__ : null;
    if (r) {
  ...
  stopButtonBouncing(e) {
    var t,
      o,
      n = [e.getChildByName("btnShuffle"), e.getChildByName("btnPropHint")];
    try {
  ...
  checkAndStartBouncing() {
    ...
    if (o && !((null !== (t = null === (e = o.getCurTilesCnt) || void 0 === e ? void 0 : e.call(o)) && void 0 !== t ? t : 0) <= 2) && 1 === o.getCanMatchCardPairNum() && null != this._willBeDead) {
      var n = this.context.gameView,
        i = null == n ? void 0 : n.bottomRootNode;
      if (i && cc.isValid(i)) {
        var r = i.getChildByName("btnShuffle"),
          a = i.getChildByName("btnPropHint"),
          l = this._willBeDead ? r : a;
        if (l && cc.isValid(l)) {
          var s = {
            isBouncing: true,
  ...
  playButtonBounceAnimation(e) {
    var t = this,
      o = e.__match1PropTipsBounceData__;
