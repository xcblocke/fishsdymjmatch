...
export class StackShuffleBehavior extends GameBehaviorsBase {
  @mj.traitEvent("StackShfBhv_playAud")
  playShuffleAudio() {
    mj.audioManager.playEffect(EAudioID.RefreshRoll);
  }
  start() {
  ...
  playShuffleAnimation() {
    ...
    if (0 !== n.length) {
      ...
      var a = this.getCenterPosition(n[0].cardNode.parent),
        l = {
          tileNodes: n,
          centerPos: a,
