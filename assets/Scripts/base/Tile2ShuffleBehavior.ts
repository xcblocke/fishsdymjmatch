...
export class Tile2ShuffleBehavior extends GameBehaviorsBase {
  playShuffleAudio() {
  ...
  start() {
    ...
    var r = new d(),
      ...
      u = l.phase2Time,
      p = l.stayEndTime,
      f = this.context.getTileNodeManager(),
      h = f.getTileNodes().filter(function (e) {
        var t;
    ...
    if (0 !== h.length) {
      ...
      cc.tween(f.root).delay(s).call(function () {
        ...
        var e,
          t,
          o = f.getTileNodes().filter(function (e) {
            var t;
            return (null === (t = e.tileObject) || void 0 === t ? void 0 : t.isValid) && !e.tileObject.getIsInSlotBar();
          });
        try {
  ...
  playLayerAnimation(e, t) {
    ...
    for (c = 0; c < l.length; c++) {
      var v = this.calcLayerParams(c, l.length, t),
        g = (T = v.expandTime) + (b = v.backTime);
      if (g >= m) {
        m = g;
        y = c;
      }
    }
    for (c = 0; c < l.length; c++) for (var _ = this.calcLayerParams(c, l.length, t), T = _.expandTime, C = _.expandDist, b = _.backTime, E = (u = l[c], 0); E < u.tileNodeObjects.length; E++) {
  ...
  playExpandAnimation(e, t, o, n, i, r, a) {
  ...
  playShuffleVibrate() {
    VibrateManager.executeVibrate(EVibrateStrength.DoubleWeak, EVibratePoint.Tile2ShuffleDone);
  }
}