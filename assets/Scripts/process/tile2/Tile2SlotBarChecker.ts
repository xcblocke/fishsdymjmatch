...
export class Tile2SlotBarChecker extends BaseCoreObject {
  constructor(t) {
    super(t);
  }
  ...
  checkCanClearWithTileId(e) {
    var t, o;
    if (!e) return false;
    var n = this._context.getGameData().slotBarIds,
    ...
    try {
      for (var l = __values(n), s = l.next(); !s.done; s = l.next()) {
        var c = s.value,
          u = i.getTileObjectByPosId(c);
        if (u && u.isValid && e != u.id && a.cardId === u.cardId) return true;
      }
    } catch (e) {
      t = {
        error: e
  ...
  checkCanClear() {
    ...
    try {
      for (var i = __values(o), a = i.next(); !a.done; a = i.next()) {
        var l = a.value,
          s = n.getTileObjectByPosId(l);
        if (s && s.isValid) for (var c = 0; c < o.length; c++) {
          var u = o[c];
          if (u !== l) {
            var p = n.getTileObject(u);
            if (p && s.cardId === p.cardId) return true;
          }
        }
      }
    } catch (t) {
  ...
  getSlotBarChangeList(e, t) {
    var o,
      n,
      i = [],
      a = this._context.getTileMapObject(),
      s = new Set([...e, ...t].filter(function (e) {
        return !!e;
      }));
    try {
  ...
  getSlotBarChangeListOnce(e, t, o, n) {
    var i,
      a,
      l,
      s,
    ...
    try {
      for (var h = __values(n), y = h.next(); !y.done; y = h.next()) {
        var m = y.value,
          v = null === (l = this._context.getTileMapObject().getTileObjectByPosId(m[0])) || void 0 === l ? void 0 : l.id,
          g = null === (s = this._context.getTileMapObject().getTileObjectByPosId(m[1])) || void 0 === s ? void 0 : s.id;
        f.add(v);
        f.add(g);
        d.set(v, g);
        d.set(g, v);
    ...
    for (var _ = this.getSlotBarChangeListFull(e, t), T = e[e.length - 1], C = T && (null === (u = this._context.getTileMapObject().getTileObjectByPosId(T)) || void 0 === u ? void 0 : u.id), b = function b(e) {
      ...
      if (f.has(S.tileId)) {
        ...
        if (S.tileId == C || d.get(S.tileId) == C || S.oldIndex < 0 && x && x.oldIndex < 0) {
          B = ETile2ClearType.InSlotBar;
          w = S.index;
        } else {
          B = ETile2ClearType.OutSlotBar;
          w = -1;
        }
        I = S.oldIndex < 0;
        S.clearInfo = {
    ...
    for (E = 0; E < p.length; E++) !(S = p[E]).clearInfo && S.oldIndex < 0 && S.index >= A - 1 && (S.isDead = true);
    return p;
  }
}