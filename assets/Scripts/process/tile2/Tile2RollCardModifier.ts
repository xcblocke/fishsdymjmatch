...
export default class Tile2RollCardModifier extends BaseCoreObject {
  getRvertIgnoreIds() {
    var e,
      t,
      o = [],
      n = this._context.getTileMapObject().tileObjectMap();
    try {
  ...
  modifyRollCardDatas(e) {
    var t, o;
    e || (e = []);
    var n = [],
      i = this._context.getTileMapObject().tileObjectMap();
    try {
      for (var a = __values(i.values()), l = a.next(); !l.done; l = a.next()) {
        var s = l.value;
        if (s.isHasRollCard() && !e.includes(s.id)) if (s.isValid) {
          if (s.getIsBack()) {
            if (s.getIsInSlotBar()) {
              s.setIsBack(false);
              n.push({
  ...
  tryFront2Back(e) {
    ...
    try {
      for (var i = __values(e), a = i.next(); !a.done; a = i.next()) {
        var l = a.value,
          s = this._context.getTileMapObject().getTileObject(l);
  ...
  getRollCardDatas(e) {
    var t,
      o,
      n = [],
      i = this.context.tile2RollCardChecker.getOpenRollCardTileObjectIds(),
      a = this.tryBack2Front(e);
    if (a) {
      n.push(a);
      try {
