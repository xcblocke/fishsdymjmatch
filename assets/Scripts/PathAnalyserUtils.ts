export class PathAnalyserUtils {
  static getLegalMoves(e, t) {
    var o,
      n,
      a,
      l,
    ...
    try {
      for (var h = __values(u), y = h.next(); !y.done; y = h.next()) {
        var m = __read(y.value, 2),
          v = (m[0], m[1]);
        if (!(v.length < 2)) for (var g = 0; g < v.length; g++) for (var _ = g + 1; _ < v.length; _++) c.push(this.createPairFromSimple(v[g], v[_]));
      }
    } catch (e) {
      a = {
        error: e
  ...
  static createPairFromSimple(e, t) {
    return {
  ...
  static isConflict(e, t) {
    var o,
      ...
      r,
      a,
      l = [e.tile1.id, e.tile2.id],
      s = [t.tile1.id, t.tile2.id];
    try {
  ...
  static hasMoveGroupListSubSet(e, t) {
    var o, n, r, a;
    try {
      for (var l = __values(e), s = l.next(); !s.done; s = l.next()) {
        ...
        if (u && c.length < t.length) return true;
      }
    } catch (e) {
      o = {
        error: e
