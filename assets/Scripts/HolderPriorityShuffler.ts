...
export class HolderPriorityShuffler extends BaseCoreObject {
  constructor(t) {
    super(t);
  }
  apply(e) {
    var t = this._context.getTileMapObject(),
      ...
      n = this.pickHolderCardIds(o, t, e);
    if (0 !== n.length) for (var i = 0; i < n.length; i++) this.ensureMatchable(n[i], t, e);
  }
  hasSolution() {
  ...
  pickHolderCardIds(e, t, o) {
    ...
    switch (o.holderPickMode) {
      ...
      case "eachOne":
        return [...new Set(i.map(function (e) {
          return e.cardId;
        }))];
      case "mostCountOne":
        var r = new Map();
