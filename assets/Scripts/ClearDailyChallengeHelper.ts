...
export default class ClearDailyChallengeHelper {
  ...
  static runClear(e, t, o) {
    ...
    var s = this.calAddScore(),
      c = __read(this.modifyClearHitTips(n), 2),
      u = c[0],
      p = c[1],
      f = this.canShowCombo(),
      d = this.getComboNum(),
    ...
    var e = this,
      ...
      o = function o(n) {
        ...
        if (i) {
          ...
          var p = e._gameContext.tileTypesModifier.modifyBombCard(e._input, i.bombIds),
            f = p.addScore,
            v = p.combo,
            g = p.showCombo,
            _ = new BombEffect({
  ...
  static pushBeforeDailyChallengeEndEffect() {
  ...
  static pushDailyChallengeEndEffect(e) {
    var t = new DailyChallengeEndEffect({
