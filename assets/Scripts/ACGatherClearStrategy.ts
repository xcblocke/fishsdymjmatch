...
export class ACGatherClearStrategy {
  getName() {
    return "ACGatherClearStrategy";
  }
  _reparentKeepWorld(e, t) {
  ...
  play(e, t) {
    ...
    try {
      for (var P = __values(S), A = P.next(); !A.done; A = P.next()) {
        ...
        if (null === (v = null === (m = null === (y = R.tileObj) || void 0 === y ? void 0 : y.tileObject) || void 0 === m ? void 0 : m.getIsInSlotBar) || void 0 === v ? void 0 : v.call(m)) {
          ...
          applyAllClearSlotCardNodeScaleToBoard(R.cardNode, R.cardNode, D);
        }
      }
    } catch (e) {
      p = {
    ...
    if (0 !== S.length) {
      var k = null !== (C = t.beamOriginWorld) && void 0 !== C ? C : cc.v2(0.5 * cc.winSize.width, 0.88 * cc.winSize.height),
        L = b.convertToNodeSpaceAR(k),
        G = S.slice(0, 15),
        F = function F(e) {
          var t,
            o,
          ...
          if (cc.isValid(i)) {
            ...
            if (r && !r.getChildByName("glow")) {
              ...
              l && (l.active = false);
              var s = BaseSpine.create("spine/gameplay_majong_glow", "in", 1, null, false, "r_gatherClear");
              s.node.name = "glow";
              s.node.parent = r;
        ...
        U = function U(e) {
          return new Promise(function (t) {
            ...
            var n = o.length;
            if (0 !== n) {
              var i = cc.v3(e.x, e.y, 0),
                r = 0;
              o.forEach(function (o) {
                var a = o.tileObj,
                  l = o.cardNode,
                  s = o.localPos,
                  c = null == a ? void 0 : a.shadowCardNode;
                ...
                var u = s.x - e.x,
                  p = s.y - e.y,
                  f = Math.sqrt(u * u + p * p) || 1,
                  d = cc.v3(s.x + u / f * 50, s.y + p / f * 50, 0);
                cc.tween(l).to(0.13, {
                  position: d
                }, {
                  easing: "cubicOut"
        ...
        H = function H() {
          ...
          try {
            ...
            if (t) {
              var o = DataReader.getByKey(ConfigType.MaterialConfig, t);
              o && o.Color && (e = o.Color);
            }
          } catch (e) {}
          var n = new cc.Color();
        ...
        W = function W(e, t, o) {
          return new Promise(function (n) {
            var i = b.convertToNodeSpaceAR(t),
              r = false,
              l = function l() {
                if (!r) {
                  r = true;
              ...
              s = BaseSpine.create(e, "in", 1, function () {
                return l();
              }, true, "r_gatherClear");
            s.node.parent = b;
        ...
        z = cc.v2(0.5 * cc.winSize.width, 0.5 * cc.winSize.height),
        Y = b.convertToNodeSpaceAR(z);
        ...
        return t = e, new Promise(function (e) {
          ...
          if (0 !== o) {
            ...
            var c = function c(i) {
              var a = G[i],
                l = a.localPos,
                s = 0.3 - (o > 1 ? i / (o - 1) : 1) * 0.12999999999999998,
                c = new cc.Node("__acgc_bd__");
              c.parent = b;
              E.push(c);
...
AllClearStrategyRegistry.register(8, new ACGatherClearStrategy());