...
import DailySignSimpleUI from './DailySignSimpleUI';
import BaseSprite from '../../../Scripts/gamePlay/base/ui/BaseSprite';
import BaseUI from '../../../Scripts/framework/ui/BaseUI';
import DailySignSimpleModel, { DailySignSimpleState } from './DailySignSimpleModel';
import DailySignSimpleRewardView from './DailySignSimpleRewardView';
...
export default class DailySignSimpleTrait extends Trait {
  _uiNode = null;
  _uiComponent = null;
  _model = null;
  static traitKey = "DailySignSimple";
  onLoad() {
  ...
  isFeatureEnabled() {
    ...
    if (!t) return false;
    var e = t.getInstance();
    if (!e || true !== e.eventEnabled) return false;
  ...
  hasClaimableSign() {
    ...
    return this._model.getDayState(t) === DailySignSimpleState.Ready;
  }
  onTaskListView_onLoad(t, e) {
    if (this.isFeatureEnabled()) {
      t.ins._cellHeight = 170;
      e();
    } else e();
  }
  onTaskItemVw_onLoad(t, e) {
    if (this.isFeatureEnabled()) {
      var i = t.ins;
  ...
  updateUI(t) {
    var e,
      ...
      a,
      r,
      s = t.node.getChildByName("content").getChildByName("board_bg");
    if (s) {
      BaseSprite.refreshWithNode(s, "texture/daily_bg_pop_1", false, true, "r_dailySignSimple");
      s.width = 978;
      s.height = 1186;
    ...
    if (d) {
      BaseSprite.refreshWithNode(d, "texture/daily_bg_pop_2", false, true, "r_dailySignSimple");
      var h = d.getComponent(cc.Sprite);
      h && (h.sizeMode = cc.Sprite.SizeMode.RAW);
    }
    var p = cc.find("content/top", t.node);
    p && BaseUI.createUI("prefabs/DailySignSimpleTitle", "r_dailySignSimple").then(function (t) {
      if (t && cc.isValid(p)) {
        p.addChild(t);
    ...
    cc.find("content/top/lbl_title", t.node).getComponent(I18NComponent).setTranslateId("Dailylog_title1", "Daily Bonus");
  }
  attachDailySignUI(t) {
    var e = this;
    if (t && cc.isValid(t.node)) if (this._uiNode && cc.isValid(this._uiNode)) {
      ...
      this.trackPageShow();
    } else DailySignSimpleUI.createUI().then(function (i) {
      if (i && cc.isValid(t.node)) {
        i.parent = t.node;
        i.setPosition(0, 377, 0);
        e._uiNode = i;
        e._uiComponent = i.getComponent(DailySignSimpleUI);
  ...
  trackPageShow() {
    var t = this._model.getCurrentDay() + 1,
      e = this._model.getCurrentProgress();
  ...
  showRewardPanel(t, e) {
    var i = this;
    DailySignSimpleRewardView.createUI().then(function (o) {
      var n;
      if (o) {
        var a = null === (n = i._uiNode) || void 0 === n ? void 0 : n.parent;
        if (a && cc.isValid(a)) {
          a.addChild(o);
          var r = o.getComponent(DailySignSimpleRewardView);
          if (r) {
