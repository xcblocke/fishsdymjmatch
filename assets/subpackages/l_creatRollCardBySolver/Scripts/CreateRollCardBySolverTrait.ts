...
export default class CreateRollCardBySolverTrait extends ExtractTrait {
  _cachedSlover = "";
  static traitKey = "CreateRollCardBySolver";
  onLoad() {
    super.onLoad.call(this);
  }
  onIptT2SetLv_reGenFaces(r, e) {
  ...
  _generateRollCards(r) {
    var e,
      ...
      C,
      R,
      E = LevelUtil.parseStepSolver(this._cachedSlover);
    if (0 !== E.length) {
      var M = r.getTileMapObject(),
        j = [];
      M.tileObjectMap().forEach(function (r) {
        r.isValid && j.push(r);
      });
      var O = new DependencyGraph();
      O.init(j, M);
      var G = new Map(),
        P = new Set(j);
      try {
      ...
      var F = SolverUtils.parsePairings(E, M.tileObjectMap()).pairs,
        I = this._traitData || {},
        Q = I.mode || 1,
        A = null !== (h = I.maxPosDiff) && void 0 !== h ? h : 3,
        H = false !== I.isDepend,
        V = [null !== (S = null === (_ = I.probMode1) || void 0 === _ ? void 0 : _[0]) && void 0 !== S ? S : u[0], null !== (T = null === (m = I.probMode1) || void 0 === m ? void 0 : m[1]) && void 0 !== T ? T : u[1], null !== (g = null === (b = I.probMode1) || void 0 === b ? void 0 : b[2]) && void 0 !== g ? g : u[2]],
        z = [null !== (w = null === (x = I.probMode2) || void 0 === x ? void 0 : x[0]) && void 0 !== w ? w : f[0], null !== (R = null === (C = I.probMode2) || void 0 === C ? void 0 : C[1]) && void 0 !== R ? R : f[1]],
        K = [];
      try {
        for (var J = __values(F), W = J.next(); !W.done; W = J.next()) {
          ...
          if (!($ > A)) {
            if (H) {
              var rr = O.getExpanded("pred", Z.coord),
                er = O.getExpanded("left", Z.coord),
                tr = O.getExpanded("right", Z.coord);
              if (!(rr.has(Y.coord) || er.has(Y.coord) || tr.has(Y.coord))) continue;
            }
            var or = 1 === Q ? Z.tile : Y.tile;
            if (!L.has(or.id) && or.type === ETileType.Normal) {
      ...
      try {
        for (var nr = __values(ir), lr = nr.next(); !lr.done; lr = nr.next()) {
          var cr = lr.value;
          M.setTileType(cr.tile.id, ETileType.RollCard);
        }
      } catch (r) {
        v = {
          error: r
      ...
      for (var c = __values(r), s = c.next(); !s.done; s = c.next()) {
        ...
        try {
          for (var p = (a = void 0, __values(l)), u = p.next(); !u.done; u = p.next()) {
            var f = u.value,
              y = d.intervalStart >= f.intervalStart && d.intervalStart <= f.intervalEnd,
              h = f.intervalStart >= d.intervalStart && f.intervalStart <= d.intervalEnd;
            if (y || h) {
              v = true;
              break;
            }
