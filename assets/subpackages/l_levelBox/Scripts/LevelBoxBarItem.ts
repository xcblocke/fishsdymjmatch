...
export enum ELevelBoxBarState {
  Node = 0,
  Normal = 1,
  HighLight = 2,
  Completed = 3,
}
export enum ELevelBoxBarPos {
  First = 0,
  Middle = 1,
  Last = 2,
}
@mj.class
export default class LevelBoxBarItem extends BaseUI {
  _barBg = null;
  _bar = null;
  _highLight = null;
  _barNode = null;
  pathIndex = ELevelBoxBarPos.Middle;
  static prefabUrl = "prefabs/levelBox/BarItem";
  get barBg() {
