...
export default class RankCollectOptTrait extends Trait {
  _rankCollectCard = null;
  _arrivedAnimPlaying = false;
  static traitKey = "RankCollectOpt";
  static BUNDLE_NAME = "r_rankCollectOpt";
  onRkSpCardTrait_showColEff(e, t) {
    var r = e.args[0],
      i = e.args[1],
      n = e.args[2],
      c = e.args[3],
    ...
    try {
      ...
      console.error("[" + RankCollectOptTrait.traitKey + "] 创建优化特效失败: " + e.message);
    }
  }
  startCollectAnim(e, t, a, r) {
    var i = this,
      n = r.gameView;
    if (cc.isValid(n) && cc.isValid(n.nodeTopEffectRoot)) {
      var c = n.nodeTopEffectRoot,
        o = mj.getClassByName("RankSpecialCardEffect");
      o && o.createUI(o.getUrl()).then(function (t) {
        ...
        if (t && cc.isValid(c)) {
          ...
          var l = cc.find("card_0", n),
            s = cc.find("card_1", n),
            f = null === (r = n.getChildByName("sp_collision")) || void 0 === r ? void 0 : r.getComponent(sp.Skeleton);
          i.initCards(l, s, a, n);
          i.refreshCardImages(l, s);
          if (cc.isValid(i._rankCollectCard) && cc.isValid(i._rankCollectCard.node)) {
            var d = i._rankCollectCard.node,
              u = d.parent.convertToWorldSpaceAR(d.position),
              p = n.convertToNodeSpaceAR(u),
              y = e.y < cc.winSize.height / 2;
    ...
    [e, t].forEach(function (e) {
      ...
      if (t) {
        ...
        if (null == a ? void 0 : a.activeInHierarchy) {
          ...
          BaseSprite.refreshWithNode(a, r.path, r.fromAtlas, false, r.bundleName);
        }
        var i = t.getChildByName("card");
        if (null == i ? void 0 : i.activeInHierarchy) {
          var n = UserModel.getInstance().getRankCardResName();
          r = CardUtil.getAtlasPathAndBundleName(n);
          BaseSprite.refreshWithNode(i, r.path, r.fromAtlas, false, r.bundleName);
        }
      }
    });
  }
  runSequence(e, t, a, r, i, n) {
    var c = this;
    this.phase3Deformation(e, t, a).then(function () {
      if (cc.isValid(r)) return c.phase4Collection(e, t, r, i, n);
    }).then(function () {
      cc.isValid(r) && r.destroy();
    });
  }
  phase1Separation(e, t) {
  ...
  flyCardToTarget(e, t, a, r, i, n) {
    var c = e.getComponent("RankSpecialCardEffect"),
      o = c["_card" + t],
      l = c["_cardContent" + t],
      s = c["_spLight" + t];
    if (cc.isValid(o)) {
  ...
  triggerCardArrived() {
    ...
    if (cc.isValid(this._rankCollectCard) && !this._arrivedAnimPlaying) {
      ...
      var t = this._rankCollectCard,
        a = t.node,
        r = t._cardNode,
        i = t.lab_count,
        n = t.bg,
        c = BaseSpine.create("spine/gameplay_light_goal", "in", -1, null, true, "r_rankCollectOpt");
      c.node.parent = n;
      ...
      } else this._arrivedAnimPlaying = false;
    }
  }
}