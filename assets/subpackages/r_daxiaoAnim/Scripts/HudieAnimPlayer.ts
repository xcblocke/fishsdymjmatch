...
export class HudieAnimPlayer {
  ...
  static playFullAnimation(t, i) {
    ...
    try {
      for (var u = __values(i), p = u.next(); !p.done; p = u.next()) {
        var h = p.value,
          f = null === (r = s.getTileNodeByTileId(h.tileId1)) || void 0 === r ? void 0 : r.tileNode;
        f && d.hideFlowLight(f);
  ...
  setupPositions(e) {
    var t = e.length,
      i = this.LAYOUT_CONFIGS[t];
    if (i) {
      var n = e[0].cardNode1.getContentSize().height,
        o = e[0].cardNode1.getContentSize().width * this.LAYOUT_SPACING_X,
        a = n * this.LAYOUT_SPACING_Y,
        r = [];
      ...
      for (var c = i.length, s = -(c - 1) * o / 2, l = 0, d = 0, u = 0; u < c; u++) for (var p = i[u], h = s + u * o, f = (p - 1) * a / 2, y = 0; y < p && !(l >= r.length); y++) {
        var m = r[l],
          g = f - y * a,
          v = cc.v3(h, g, 0);
        if (m.isCard1) {
    ...
    } else this.setupDefaultPositions(e);
  }
  setupDefaultPositions(e) {
    var t = e[0].cardNode1.getContentSize().height,
      i = e[0].cardNode1.getContentSize().width,
      n = t * this.LAYOUT_SPACING_Y,
      o = i * this.LAYOUT_SPACING_X / 2,
      a = e.length * n / 2 - n / 2;
  ...
  playPhase1() {
    var e = this,
      ...
      i = this.context.effectNode.convertToNodeSpaceAR(t);
  ...
  createParticle(e, t, i, n, o, r) {
    ...
    return new Promise(function (s) {
      ...
      var u = BaseSprite.create(c.RES_PARTICLE, c.RES_BUNDLE);
      if (u && u.node) {
        u.node.parent = d;
        u.node.scale = 2;
      }
  ...
  playPhase2() {
    for (var e = this, t = [], i = function i(i) {
      ...
      }, n = this, o = 0; o < this.nodeInfos.length; o++) i(o);
  ...
  playPhase3() {
    ...
    return Promise.all(t).then(function () {
      var t,
        i = null === (t = e.nodeInfos[0]) || void 0 === t ? void 0 : t.cardNode1;
  ...
  playPhase4() {
    ...
    var a = cc.v3(i / o, n / o, 0),
      r = [];
    this.nodeInfos.forEach(function (e) {
      r.push(t.playCardCollision(e.cardNode1, a));
      r.push(t.playCardCollision(e.cardNode2, a));
    });
    var c = this.COLLISION_DELAY + this.COLLISION_OUT_DURATION,
      s = null === (e = this.nodeInfos[0]) || void 0 === e ? void 0 : e.cardNode1;
  ...
  playCardCollision(e, t) {
    ...
    var i = e.position.clone(),
      n = i.clone().sub(t).normalize(),
      o = i.clone().add(n.mul(this.COLLISION_OUT_DISTANCE));
  ...
  playCollisionEffect(e) {
    var t = BaseSpine.create(this.RES_EFFECT_SPINE, this.PHASE4_COLLISION_ANIM, 1, null, true, this.RES_BUNDLE);
  ...
  fadeToDark() {
    ...
    if (cc.isValid(this.maskLayer) && this.maskGraphics) {
      var t = this.FADE_TO_DARK_OPACITY,
        i = cc.winSize;
