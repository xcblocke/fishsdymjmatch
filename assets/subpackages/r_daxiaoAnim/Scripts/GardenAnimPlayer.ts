...
export class GardenAnimPlayer {
  nodeInfos = [];
  completedCount = 0;
  maskLayer = null;
  maskGraphics = null;
  eliminationSpines = new Map();
  globalEffectPlayed = false;
  context = null;
  config = null;
  constructor(e, t) {
    this.context = e;
  ...
  static playFullAnimation(t, i) {
    var n = GardenAnimPlayer.createAnimContext(t),
      o = new GardenAnimPlayer(n, GardenAnimPlayer.getConfig());
  ...
  setupPositions(e) {
    this.sortInfos(e);
    var t = e[0].cardNode1.getContentSize().width,
      i = e[0].cardNode1.getContentSize().height,
      n = this.calculateHeartLayout(t, i, e.length);
  ...
  calculateZIndex(e) {
    var t = e.length,
      i = this.config.heartLayout[t];
    i || (i = this.config.heartLayout[7]);
    var n = i.zIndexOffsets || [],
      o = this.config.zIndexMultiplier || 1000;
  ...
  calculateHeartLayout(e, t, i) {
    var n = [],
      o = this.config.heartLayout[i];
    o || (o = this.config.heartLayout[7]);
    for (var a = Math.min.apply(Math, [...o.rowYOffsets]), c = -(Math.max.apply(Math, [...o.rowYOffsets]) - a) * t / 2 - a * t, s = 0; s < i; s++) {
      var l = o.rowYOffsets[s],
        d = o.rowXOffsets[s];
      n[s] = {
        x1: -e / 2 - d * e,
        y1: c + l * t,
  ...
  playTrailEffect(e, t, i, n, o, a, r) {
    ...
    d.scale = t || 1;
    if (a.trailSpine) {
      BaseSpine.create(a.trailSpine.path, a.trailSpine.anim || "in", -1, null, false, a.trailSpine.bundle).node.parent = d;
    } else {
      a.trailSprite && (BaseSprite.create(a.trailSprite.path, a.trailSprite.bundle).node.parent = d);
    }
  ...
  showFlowLight(e, t, i, n, o) {
    ...
    if (!e.getChildByName("DaxiaoFlowLightNode")) {
      ...
      e.addChild(r);
      r.scale = t;
      BaseSpine.refreshWithNode(r, i, n).setAnimation(o || "init", -1, null, false);
    }
  }
  playHitEffect(e, t, i, n, o, a = true) {
    var r = BaseSpine.create(i, o || "in", 1, null, false, n);
  ...
  executeTrailAndCard2(e) {
    var t = this;
    if (cc.isValid(e.cardNode1) && cc.isValid(e.cardNode2)) {
      var i = e.cardNode1.position.clone(),
  ...
  executeCard2Bezier(e) {
    var t = this.config.phase2.bezier,
      i = this.nodeInfos.length,
      o = t.duration + (i - e.runIndex - 1) * this.config.phase1.delay + (i - e.runIndex - 1) * this.config.phase1.delay * 2,
      a = Object.assign(Object.assign({}, t), {
        duration: o
      });
    return this.applyBezierMove(e.cardNode2, e.targetPos2, a, true);
  }
  applyBezierMove(e, t, i, n = false) {
    var o, a, r, c, s;
    if (void 0 !== i.angle || void 0 !== i.scale) {
      var l = null !== (o = i.transformDuration) && void 0 !== o ? o : i.duration,
        d = null !== (a = i.restoreDelay) && void 0 !== a ? a : i.duration,
        u = n ? -(null !== (r = i.angle) && void 0 !== r ? r : 0) : null !== (c = i.angle) && void 0 !== c ? c : 0;
      cc.tween(e).to(l, {
        angle: u,
  ...
  playCard2Bezier(e) {
    var t,
      ...
      n,
      o,
      a = this.config.phase2.bezier;
    if (void 0 !== a.angle || void 0 !== a.scale) {
      var r = null !== (t = a.transformDuration) && void 0 !== t ? t : a.duration,
        c = null !== (i = a.restoreDelay) && void 0 !== i ? i : a.duration;
  ...
  startPhase3ArrayEffect() {
    var e = this,
      t = this.config.arrayEffect;
  ...
  createEliminationASpines() {
    var e = this,
      t = this.config.resources;
    if (t.eliminationA) {
      var i = ["in_1", "in_2", "in_3"],
        n = ["out_1", "out_2", "out_3"],
        o = this.nodeInfos.length,
        a = this.config.heartLayout[o];
      a || (a = this.config.heartLayout[7]);
      var r = a.animIndexesLeft || [1, 2, 3, 1, 2, 3, 1],
        c = a.animIndexesRight || [1, 2, 3, 1, 2, 3, 1];
      this.nodeInfos.forEach(function (o, a) {
        if (cc.isValid(o.cardNode1) && cc.isValid(o.cardNode2)) {
          var l = e.context.layoutScale,
            d = r[a] || 1,
            u = i[d - 1],
            p = n[d - 1],
            h = BaseSpine.create(t.eliminationA.path, u, 1, function () {
          ...
          var f = c[a] || 1,
            y = i[f - 1],
            m = n[f - 1],
            g = BaseSpine.create(t.eliminationA.path, y, 1, function () {
  ...
  applyGlobalEffect() {
    ...
    if (e.eliminationEffect && !this.globalEffectPlayed) {
      ...
      var t = BaseSpine.create(e.eliminationEffect.path, e.eliminationEffect.anim || "in", 1, null, true, e.eliminationEffect.bundle);
    ...
    if (t.eliminationB) {
      ...
      this.nodeInfos.forEach(function (n) {
        if (cc.isValid(n.cardNode1) && cc.isValid(n.cardNode2)) {
          var o = i[Math.floor(2 * Math.random())],
            a = BaseSpine.create(t.eliminationB.path, o, 1, null, true, t.eliminationB.bundle);
          ...
          r && (r.bSpine = a);
          var c = BaseSpine.create(t.eliminationB.path, o, 1, null, true, t.eliminationB.bundle);
  ...
  applyExpandAnimation() {
    ...
    this.nodeInfos.forEach(function (n) {
      if (cc.isValid(n.cardNode1) && cc.isValid(n.cardNode2)) {
        var o = n.cardNode1.position.clone().normalize(),
          a = n.cardNode2.position.clone().normalize(),
          r = n.cardNode1.position.clone().sub(o.mul(t.moveInDistance)),
          c = n.cardNode2.position.clone().sub(a.mul(t.moveInDistance)),
          s = n.cardNode1.position.clone().add(o.mul(t.moveOutDistance)),
          l = n.cardNode2.position.clone().add(a.mul(t.moveOutDistance));
