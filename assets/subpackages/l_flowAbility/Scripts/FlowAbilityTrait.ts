...
export default class FlowAbilityTrait extends Trait {
  static traitKey = "FlowAbility";
  onLoad() {
    var a, e, r, i, o, l, n, s;
    ...
    try {
      ...
      try {
        for (var y = __values(_), g = y.next(); !g.done; g = y.next()) {
          var D = g.value,
            S = null === (s = h.getTileObjectByPosId) || void 0 === s ? void 0 : s.call(h, D);
          S && v.add(S.cardId);
        }
      } catch (t) {
        e = {
      ...
      var m = this._getOperableCardIds(h),
        w = false;
      try {
  ...
  _evaluateAndAdjust() {
    var t = this.localData.faOpDurSum || 0,
      a = this.localData.faOpCount || 0;
    this.localData.faOpDurSum = 0;
    this.localData.faOpCount = 0;
    if (!(a <= 0)) {
      var e = t / a,
        r = this.localData.faStage || this._initialStage;
