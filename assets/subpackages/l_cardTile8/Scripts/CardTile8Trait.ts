...
export default class CardTile8Trait extends Trait {
  _currentMapping = {};
  _gapTime = 86400000;
  _shouldEnableSkin = false;
  static traitKey = "CardTile8";
  ...
  _generateRandomMapping() {
    var t,
      e = {},
      a = CardTile8Trait.ALL_CARDS.slice(0, 18).filter(function (t) {
        return t && t.length > 0;
      });
    if (18 !== a.length) return e;
    var i = this._getTaskCardResName(),
      n = CardTile8Trait.ALL_CARDS.filter(function (t) {
        return t && t.length > 0;
      });
  ...
  onGsListener_onNewGame(t, e) {
    try {
      ...
      console.error("[" + CardTile8Trait.traitKey + "] 关卡切换处理失败: " + (null == t ? void 0 : t.message));
    }
    e();
  }
  onCardUtil_atlasPathBundle(t, e) {
    ...
    try {
      ...
      if (i !== MjGameType.Travel && i !== MjGameType.DailyChallenge) {
        e();
        return;
      }
      ...
      console.error("[" + CardTile8Trait.traitKey + "] 劫持图片失败: " + (null == t ? void 0 : t.message));
      e();
    }
  }
}