...
export default class MaterialCard5Trait extends MaterialCardBaseTrait {
  _startLevel = 6;
  _interval = 5;
  static traitKey = "MaterialCard5";
  onLoad() {
    var e, r, a, i;
  ...
  onGsListener_onNewGame(t, e) {
    try {
      ...
      console.error("[" + MaterialCard5Trait.traitKey + "] 处理新游戏事件失败: " + (null == t ? void 0 : t.message));
      e();
    }
  }
  onTLWinVw_showTLWinVw(t, e) {
    try {
      ...
      console.error("[" + MaterialCard5Trait.traitKey + "] 旅行胜利处理失败: " + (null == t ? void 0 : t.message));
    }
    e();
  }
}