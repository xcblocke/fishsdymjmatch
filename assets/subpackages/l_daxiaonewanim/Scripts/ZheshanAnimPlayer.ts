...
export class ZheshanAnimPlayer {
  nodeInfos = [];
  completedCount = 0;
  maskLayer = null;
  maskGraphics = null;
  ...
  playCollision(t) {
    ...
    var i = this.nodeInfos[0].cardNode1.getContentSize().height,
      a = this.nodeInfos[0].cardNode1.getContentSize().width,
      o = 0.5 * i,
