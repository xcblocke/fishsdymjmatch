...
import LowPriorityModel from '../../../Scripts/gamePlay/base/ui/LowPriorityModel';
...
export default class MaterialCardOptBaseTrait extends Trait {
  static traitKey = "MaterialCardOptBase";
  ...
  getMaterialCardList() {
    return MaterialCardOptBaseTrait.MATERIAL_CARD_LIST;
  }
  getCurMaterialCard() {
    var t;
  ...
  getAvailableMaterials() {
    var t,
      e,
      r = LowPriorityModel.getInstance(),
      a = [];
    try {
      for (var i = __values(this.getMaterialCardList()), o = i.next(); !o.done; o = i.next()) {
        ...
        if (l.isLocal) {
          ...
          if (LowPriorityBundleLoader.getInstance().isBundlePreLoaded(l.bundle)) {
            a.push(l.id);
          } else {
  ...
  isTile2Mode() {
    return this.getCurrentGameType() === MjGameType.Tile2Normal;
  }
  getCurrentGameDataLevel() {
    var t, e;
    return null !== (e = null === (t = UserModel.getInstance().getCurrentGameData()) || void 0 === t ? void 0 : t.getLevelId()) && void 0 !== e ? e : 0;
  }
  isGameModeMatch(t) {
  ...
  refreshExistingCards(t) {
    ...
    r && r.getTileNodes().forEach(function (t) {
      var e, r, a, i;
      if (null === (e = t.tileObject) || void 0 === e ? void 0 : e.isValid) try {
  ...
  loadResById(t, e) {
    var r,
      a,
      i = ControllerManager.getInstance().getControByName(t);
    if (i && "function" == typeof i.loadRes) {
      var o = Array.isArray(e) ? e : [e],
        l = function l(t) {
          var e, r;
          if (0 === t) return "continue";
          ...
          try {
            for (var l = (e = void 0, __values(m)), d = l.next(); !d.done; d = l.next()) o(d.value);
          } catch (t) {
            e = {
              error: t
            };
        ...
        s = this;
      try {
        for (var d = __values(o), u = d.next(); !u.done; u = d.next()) l(u.value);
      } catch (t) {
        r = {
          error: t
        };
