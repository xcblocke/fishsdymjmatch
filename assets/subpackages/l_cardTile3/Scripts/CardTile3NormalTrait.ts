...
export default class CardTile3NormalTrait extends Trait {
  _currentMapping = {};
  static traitKey = "CardTile3Normal";
  ...
  _generateRandomMapping() {
    var t,
      e = {},
      a = CardTile3NormalTrait.ALL_CARDS.slice(0, 18).filter(function (t) {
        return t && t.length > 0;
      });
    if (18 !== a.length) return e;
    var n = this._getTaskCardResName(),
      i = CardTile3NormalTrait.ALL_CARDS.filter(function (t) {
        return t && t.length > 0;
      });
  ...
  onGsListener_onNewGame(t, e) {
    try {
      ...
      console.error("[" + CardTile3NormalTrait.traitKey + "] 关卡切换处理失败: " + (null == t ? void 0 : t.message));
    }
    e();
  }
  onCardUtil_atlasPathBundle(t, e) {
    ...
    try {
      ...
      console.error("[" + CardTile3NormalTrait.traitKey + "] 劫持图片失败: " + (null == t ? void 0 : t.message));
      e();
    }
  }
}