...
export default class TravelMotivationalWordsTrait extends Trait {
  THRESHOLDS = [0, 30, 60, 90];
  TIER_NAMES = ["", "Great", "Excellent", "Amazing", "Unbelievable"];
  ANIMATION_NAMES = ["", "in_great", "in_excellent", "in_amazing", "in_unbelievable"];
  _gameType = MjGameType.None;
  _motivWordsNode = null;
  _lightNode = null;
  _prefabUrl = "prefabs/EffectMotivationalWordsItem";
  _lightUrl = "prefabs/EffectMotivationalLights";
  _bundleName = "r_travelMotivationalWords";
  AUDIO_IDS = [0, 13, 14, 15, 16];
  static traitKey = "TravelMotivationalWords";
  onLoad() {
  ...
  onInitViewBhv_crtTls(t, e) {
    ...
    if (this._gameType === MjGameType.Travel) {
      var c = t.ins,
        d = (null == c ? void 0 : c.context) || (null == c ? void 0 : c._context),
        u = null === (a = null === (r = null == d ? void 0 : d.getTileMapObject) || void 0 === r ? void 0 : r.call(d)) || void 0 === a ? void 0 : a.gameContext;
  ...
  onClearBhv_collision(t, e) {
    ...
    if (this._gameType === MjGameType.Travel) {
      ...
      if (r) {
        var a = null === (i = r.getTileMapObject) || void 0 === i ? void 0 : i.call(r),
          l = null == a ? void 0 : a.collectSystem;
        if (l) {
  ...
  showMotivationalWords(t, e) {
    var i,
      o = this,
      r = null == e ? void 0 : e.gameView;
    if (r) {
      this.cleanupMotivWordsNode();
      var a = (null === (i = e.getLastCollisionWorldPos) || void 0 === i ? void 0 : i.call(e)) || cc.v3(0, 0, 0),
        l = cc.v2(a.x, a.y);
      BaseUI.createUI(this._prefabUrl, this._bundleName).then(function (e) {
        var i;
        if (e && cc.isValid(e)) {
          o._motivWordsNode = e;
          var a = r.getEffectLayer(EffectLayer.Top);
          if (a && cc.isValid(a)) {
            e.parent = a;
            var n = o.getSafePosition(e, l, t),
              s = a.convertToNodeSpaceAR(n);
            ...
            if (u) {
              ...
              GameUtils.playSpine(u, v, false, function () {
  ...
  getSafePosition(t, e, i) {
    return this.clampToScreenWorld(t, e, i);
  }
  clampToScreenWorld(t, e, i) {
    var o = cc.view.getVisibleSize(),
      r = o.width,
      a = o.height,
      l = this.getWordsSize(i),
      n = l.width,
      s = l.height,
      c = t.anchorX,
      d = t.anchorY,
  ...
  showLightEffect(t) {
    ...
    i && cc.isValid(i) && BaseUI.createUI(this._lightUrl, this._bundleName).then(function (t) {
      if (t && cc.isValid(t)) {
        e._lightNode = t;
        t.parent = i;
